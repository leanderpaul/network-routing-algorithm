...
main(int argc, char** argv)
{
    ...
    if (printRoutingTables)
    {
        ...
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(10.0), a, routingStream);
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(10.0), b, routingStream);
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(10.0), c, routingStream);
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(10.0), d, routingStream);

        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(20.0), a, routingStream);
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(20.0), b, routingStream);
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(20.0), c, routingStream);
        Ipv4RoutingHelper::PrintRoutingTableAt(Seconds(20.0), d, routingStream);
