...
void printNodeInterfaces(Ptr<Node> node) {
...
int main(int argc, char** argv) {
  ...
  if (printRoutingTables) {
    Simulator::Schedule(Seconds(10), &printNodeInterfaces, src);
    Simulator::Schedule(Seconds(10), &printNodeInterfaces, dst);
    Simulator::Schedule(Seconds(10), &printNodeInterfaces, a);
    Simulator::Schedule(Seconds(10), &printNodeInterfaces, b);
    Simulator::Schedule(Seconds(10), &printNodeInterfaces, c);
    Simulator::Schedule(Seconds(10), &printNodeInterfaces, d);
  }
  ...
  ApplicationContainer apps = ping.Install("SrcNode");
